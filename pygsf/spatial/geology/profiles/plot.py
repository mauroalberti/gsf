...
def plot_structural_attitude(
    ...
    for structural_attitude in structural_attitude_list:
        if 0.0 <= structural_attitude.sign_hor_dist <= section_length:
            structural_segment_s, structural_segment_z = define_plot_structural_segment(
                structural_attitude,
                section_length,
                vertical_exaggeration
            )
...
def plot_geoprofiles(
    ...
    num_subplots = (plot_height_choice + plot_slope_choice) * geoprofiles.num_profiles()
