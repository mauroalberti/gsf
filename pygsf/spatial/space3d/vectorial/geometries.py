...
from pygsf.utils.lists import *

from pygsf.mathematics.statistics import *
from pygsf.mathematics.utils import *
from pygsf.spatial.space3d.transformations.quaternions import *
...
class CPlane(object):
    ...
    def intersPoint(self,
        ...
        Examples:
          >>> p_a = CPlane(1, 0, 0, 0, epsg_code=32632)
          >>> p_b = CPlane(0, 0, 1, 0, epsg_code=32632)
          >>> p_a.intersPoint(p_b)
          Point(0.0000, 0.0000, 0.0000, 0.0000, 32632)
          >>> p_b = CPlane(-1, 0, 0, 0, epsg_code=32632)  # parallel plane, no intersection
